...
export type CharactersQuery = { characters: { info: { count: number | null, pages: number | null, next: number | null } | null, results: Array<(
      { id: string | null }
      & { ' $fragmentRefs'?: { 'CharacterChipFragment': CharacterChipFragment } }
    ) | null> | null } | null };
